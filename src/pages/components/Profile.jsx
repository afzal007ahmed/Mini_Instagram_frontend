            ...
            <div className="flex flex-col items-center">
              <div>
                <img
                  ...
                  className="w-[100px] min-w-[100px] rounded-[100px] h-[100px] object-cover border-white border-[2px] relative -top-[40px]"
                />
                <div className={`border h-[30px] ${ userStatus?.data?.[ user.data.id ] ? "bg-green-600" : "bg-gray-500" } w-[30px] relative -top-[60px] rounded-[30px]`}></div>
              </div>
              ...
              <p>
                ...
                <span className="font-bold text-sm">{user.data?.gender}</span>{" "}
              </p>
            </div>
            <div>
              <p className="font-bold text-center">
                {followingList.data && Object.keys(followingList.data).length}
              </p>
